...
<html>
	...
	<body>
        ...
        <?php
            ...
            $buchstaben = substr_count($lorem_str,'A-Za-z');
            $leerzeichen = substr_count($lorem_str,' ');
            $kommata = substr_count($lorem_str,',');
            $punkte = substr_count($lorem_str,'.');    
        ?>
            <div>String enthält: <? echo $buchstaben; ?> Buchstaben</div>
            <div>String enthält: <? echo $leerzeichen; ?> Leerzeichen</div>
            <div>String enthält: <? echo $kommata; ?> Kommata</div>
            <div>String enthält: <? echo $punkte; ?> Punkte</div>
